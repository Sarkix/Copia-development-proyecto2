const More = () => {
  return (
    <>
      <div className="more theme-change light-theme">
        <h2>
          <div className="dropdown">
            <a
              className="more-dropdown btn btn-secondary theme-change light-theme"
              href="#"
              role="button"
            ...
            <ul className="dropdown-menu theme-change light-theme" id="more-menu">
              <li>
                <a
                  className=" more-item dropdown-item theme-change light-theme"
                  href="#"
                >
                  <h2>Info</h2>
                </a>
              ...
              <li>
                <a
                  className=" more-item dropdown-item theme-change light-theme extra-svg"
                  href="#"
                >
              ...
              <li>
                <hr className="more-item dropdown-divider theme-change light-theme" />
              </li>
              <li>
                <a
                  className="more-item dropdown-item theme-change light-theme"
